 ...
 *
 * This file is placed at glog/logging.h inside the shims directory so that
 * adding the shims directory first on the include path causes any
 * #include <glog/logging.h> to resolve here instead of the real glog.
 *
...
#ifndef WASM_SHIMS_GLOG_LOGGING_H
#define WASM_SHIMS_GLOG_LOGGING_H
...
#endif // WASM_SHIMS_GLOG_LOGGING_H
